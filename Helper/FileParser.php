...
namespace Magento\ContentInitialization\Helper;
...
/**
 * Class FileParser
 * @package Magento\ContentInitialization\Helper
 */
class FileParser
{
    /**
    ...
    public function __construct(
        ...
        $pathToData = $registrar
                ->getPath(ComponentRegistrar::MODULE, UpgradeData::MIGRATION_MODULE) . '/files/data/';
